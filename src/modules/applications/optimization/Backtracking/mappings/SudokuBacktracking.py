...
class SudokuBacktracking(Mapping):
    """
    ...
    def __init__(self):
        ...
        """
        super().__init__()
        self.submodule_options = ["BacktrackingSudoku"]
    ...
    def get_default_submodule(self, option: str) -> Core:
        ...
        if option == "BacktrackingSudoku":
            from modules.solvers.QRISPBacktrackingSolver import SudokuSolver  # pylint: disable=C0415
            return SudokuSolver()
        else:
