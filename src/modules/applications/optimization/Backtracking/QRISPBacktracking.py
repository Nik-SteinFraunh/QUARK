...
class Backtracking(Optimization):
    ...
    def __init__(self):
        ...
        self.submodule_options = ["SudokuBacktracking"]
    ...
    def get_default_submodule(self, option: str) -> Core:
        if option == "SudokuBacktracking":
            from modules.applications.optimization.Backtracking.mappings.SudokuBacktracking import SudokuBacktracking  # pylint: disable=C0415
            return SudokuBacktracking()
        else:
